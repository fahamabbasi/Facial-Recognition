...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\user\Desktop\Attendace_management_system-master\Attendance\Manually Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'kushal' :
            if password == 'kushal14320':
                ...
                cs = r'C:\Users\user\Desktop\Attendace_management_system-master\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
